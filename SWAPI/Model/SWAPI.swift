...
class SWAPI {
    ...
    static func searchForPeople(with searchTerm: String, completion: @escaping ([Person]?, Error?) -> Void) {
        ...
        // This automaticlally does all the escping so it works with the web API coding
        ...
        let dataTask = URLSession.shared.dataTask(with: request) {
            ...
            do {
                ...
                let searchResults = try jsonDecoder.decode(PersonSearchResult.self, from: data)
